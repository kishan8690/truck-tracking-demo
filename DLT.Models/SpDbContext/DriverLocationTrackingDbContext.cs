...
namespace DLT.Models.SpDbContext;
...
public partial class DriverLocationTrackingDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.DriverCurrentLocationId).HasName("PK__DriverCu__5190FB6814623278");
        ...
        {
            entity.HasKey(e => e.LocationId).HasName("PK__Location__E7FEA477ED5442E2");
        });

        modelBuilder.Entity<Trip>(entity =>
        {
            entity.HasKey(e => e.TripId).HasName("PK__Trips__51DC711E1231E8B8");
        ...
        {
            entity.HasKey(e => e.TripUpdatesId).HasName("PK__TripUpda__BB9599DB47892EFB");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCAC609CEA59");
